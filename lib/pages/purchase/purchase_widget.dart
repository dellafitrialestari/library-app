...
class _PurchaseWidgetState extends State<PurchaseWidget> {
  ...
  void initState() {
    ...
    _model.titleFocusNode5 ??= FocusNode();
  }
                            ...
                            children: [
                              ...
                              Padding(
                                padding: EdgeInsetsDirectional.fromSTEB(
                                    20.0, 14.0, 100.0, 0.0),
                                child: Text(
                                  'Use this form to suggest books for the library if you are a member of staff or a student at Muhammadiyah University of Surakarta',
                        ...
                        Expanded(
                          child: Padding(
                            ...
                            child: TextFormField(
                              ...
                              focusNode: _model.titleFocusNode4,
                              obscureText: false,
                              decoration: InputDecoration(
                                labelText: 'Year',
                                labelStyle:
                              ...
                              style: FlutterFlowTheme.of(context).bodyMedium,
                              maxLines: null,
                              validator: _model.titleController4Validator
                                  .asValidator(context),
                            ),
                          ),
                        ),
                        ...
                        Expanded(
                          child: Padding(
                            ...
                            child: TextFormField(
                              ...
                              focusNode: _model.titleFocusNode5,
                              obscureText: false,
                              decoration: InputDecoration(
                              ...
                              style: FlutterFlowTheme.of(context).bodyMedium,
                              maxLines: null,
                              validator: _model.titleController5Validator
                                  .asValidator(context),
                            ),
                          ),
                        ),
